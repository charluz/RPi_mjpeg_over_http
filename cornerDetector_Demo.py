...
myHarris_dst = cv.cornerEigenValsAndVecs(src_gray, blockSize, apertureSize)
	#-- cornerEigenValsAndVecs() 對輸入的每個 pixel 回傳六個值:
	#		lambda1, lambda2 (兩個特徵值)，x11, x12, x21, x22 (特徵矩陣)

print("Shape of myHarris_dst: ", myHarris_dst.shape)
print("DType of myHarris_dst: ", myHarris_dst.dtype)
exit()
